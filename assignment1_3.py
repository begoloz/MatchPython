...
def ask_questions(questions,choices,choices_questions_relation):
    ...
    for j in range(0,len(questions)):
        for i in range(0,len(questions[j])):
            ...
            answer = int(input())
            #saves the answers for the first group of questions in the tuple user_answers.
            if j==0:
                ...
                if answer<=3 and answer>=1:
                    ...
                    exit()
            #adds the answers for the second group of questions and saves the result in personality_answers.
            else:
